...
export class PersonalComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.route.queryParams.subscribe(params => {
      this.user = new User(params['username'], params['password'], params['email'], params['name'], params['lastname'], params['iconType'], params['userType'], null)
    });
  }
